  ...
  return (
    <div className="relative h-screen flex overflow-hidden">
      <div className="flex flex-col sm:flex-row items-center sm:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
        <div className=" md:w-1/3 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative">
        ...
        <div className="md:flex md:items-center md:justify-center w-full md:h-full md:w-2/3 xl:w-2/5 p-6  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white overflow-y-scroll">
